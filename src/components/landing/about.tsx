          ...
          <div className="relative md:pr-10">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-jost text-[13px] text-brand-dark leading-snug">{cardTitulo}</p>
                <p className="font-jost text-[11px] text-brand-dark/50 mt-1 leading-snug">{cardSubtitulo}</p>
              </div>
            </div>

            {/* Pills — desktop apenas */}
            <div style={layer(48)} className="absolute bottom-8 -left-2 hidden md:flex flex-col gap-2">
